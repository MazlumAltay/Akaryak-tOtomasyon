...
namespace AkaryakıtOtomasyon
{
    public partial class Form1 : Form
    {
        ...
        {
            //Satış yap kısmında seçili olan numericupdown kısmını aktif hale getirip daha önce ki seçili kısmı kapatıp sıfırladık.
        ...
        {
            // Satış yap buttonu ile numericupdownlardan gelen bilgileri alıp label24'e yazdırdık.
            ...
            if(numericUpDown1.Enabled==true)
            {
                ...
                label24.Text = Convert.ToString(S_benzin95 * F_benzin95);
            }
            else if (numericUpDown2.Enabled == true)
            {
                D_benzin97 = D_benzin97 - S_benzin97;
                label24.Text = Convert.ToString(S_benzin97 * F_benzin97);
            }
            else if (numericUpDown3.Enabled == true)
            {
                D_dizel = D_dizel - S_dizel;
                label24.Text = Convert.ToString(S_dizel * F_dizel);
            }
            else if (numericUpDown4.Enabled == true)
            {
                D_eurodizel = D_eurodizel - S_eurodizel;
                label24.Text = Convert.ToString(S_eurodizel * F_eurodizel);
            }
            else if (numericUpDown5.Enabled == true)
            {
                D_lpg = D_lpg - S_lpg;
                label24.Text = Convert.ToString(S_lpg * F_lpg);
            }
            ...
            System.IO.File.WriteAllLines(Application.StartupPath + "\\depo.txt", depo_bilgileri); //değpo txt dosyasına bilgileri güncelledik.
            txt_depo_oku();
            txt_depo_yaz();
        ...
        {
            //Fiyat bilgileri sekmesinde fiyat güncellemesi yaptırdım.
            try
            {
        ...
        {
            // Depo bilgilerinin üstünde girişlerde hata verdirdim.
            try
            {
            ...
            //txt dosyasına verileri yazdırdım.
        ...
        {
            label29.Text = F_benzin95.ToString("N");
            label28.Text = F_benzin97.ToString("N");
            label27.Text = F_dizel.ToString("N");
            label26.Text = F_eurodizel.ToString("N");
            label25.Text = F_lpg.ToString("N");
        }
